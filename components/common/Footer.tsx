...
export function Footer() {
  ...
  return (
    <>
      {/* Footer Section */}
      <footer className="bg-[#584f48] py-6">
        <div className="container mx-auto px-6 flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
          ...
          <div className="text-[16px] text-white text-center">
            © {new Date().getFullYear()} Copyright RISING SPACES. All Rights Reserved.
      ...
      <>
        ...
        {showWhatsAppChat && (
          <div className="fixed bottom-30 left-6 w-72 bg-white rounded-lg shadow-lg z-50 border">
            <div className="p-3 border-b bg-[#584f48] text-white font-bold flex justify-between items-center">
            ...
            <div className="p-3">
              ...
              <textarea
                rows={2}
                className="w-full p-2 border rounded-md text-sm placeholder:text-[#584f48] text-[#584f48]"
              ...
              <button
                ...
                className="mt-2 w-full bg-[#584f48] text-white py-1.5 rounded-md hover:bg-[#304c58] cursor-pointer"
              >
                Send
              </button>
            </div>
