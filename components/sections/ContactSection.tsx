...
import { FaMapMarkerAlt, FaPhoneAlt, FaEnvelope, FaFacebookF, FaInstagram, FaTwitter, FaYoutube } from 'react-icons/fa';
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
        ...
        >
          <motion.h2 
            className="text-3xl font-bold text-[#097199] mb-4"
            variants={item}
          >
            Get In Touch
          </motion.h2>
          ...
          >
            {[
              ...
              >
                <motion.div 
                  className="bg-[#097199] p-3 rounded-full text-white"
        ...
        >
          <motion.h3 
            className="text-3xl font-bold text-[#097199] mb-6"
            variants={item}
          >
            Send a Message
          </motion.h3>
