...
const constructionImages = [
  '/construction/IMG-20260620-WA0012 (1).jpg',
  '/construction/IMG-20260620-WA0013.jpg',
  '/construction/IMG-20260620-WA0014.jpg',
  '/construction/IMG-20260620-WA0015.jpg',
  '/construction/IMG-20260620-WA0016.jpg',
  '/construction/IMG-20260620-WA0017.jpg',
  '/construction/IMG-20260620-WA0018.jpg',
  '/construction/IMG-20260620-WA0019.jpg',
  '/construction/IMG-20260620-WA0020.jpg',
  '/construction/IMG-20260620-WA0021.jpg',
  '/construction/IMG-20260620-WA0022.jpg',
  '/construction/IMG-20260620-WA0024.jpg',
  '/construction/IMG-20260620-WA0025.jpg',
  '/construction/IMG-20260620-WA0026.jpg',
  '/construction/IMG-20260620-WA0029.jpg',
  '/construction/IMG-20260620-WA0030.jpg',
  '/construction/IMG-20260620-WA0031.jpg',
  '/construction/IMG-20260620-WA0032.jpg',
  '/construction/IMG-20260620-WA0033.jpg',
];
...
export function ConstructionSection() {
  ...
  const goLeft = useCallback((e?: React.MouseEvent) => {
    ...
    setLightbox((prev) => {
      ...
      return {
        ...prev,
        index: prev.index === 0 ? constructionImages.length - 1 : prev.index - 1,
      };
    });
  }, []);
  ...
  const goRight = useCallback((e?: React.MouseEvent) => {
    ...
    setLightbox((prev) => {
      ...
      return {
        ...prev,
        index: (prev.index + 1) % constructionImages.length,
      };
    });
  }, []);
  ...
  const handleLoadMore = () => {
    setVisibleCount((prev) => Math.min(prev + 6, constructionImages.length));
  };
  ...
  return (
    <section id="construction" className="py-16 bg-[#faf9f8] relative overflow-hidden">
      {/* Decorative patterns */}
      <div className="absolute top-0 right-0 w-80 h-80 bg-[#584f48]/5 rounded-full blur-3xl pointer-events-none -z-10" />
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-[#584f48]/5 rounded-full blur-3xl pointer-events-none -z-10" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          >
            Construction <span className="text-[#584f48]">Updates</span>
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 15 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            Witness the development progress and infrastructure execution of your NA plots near Hinjewadi Phase III.
          </motion.p>
        </div>

        {/* Image Grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {constructionImages.slice(0, visibleCount).map((src, index) => (
            <motion.div
              key={src}
          ...
          >
            ...
            >
              <div className="relative w-full h-full">
                <Image
                  src={constructionImages[lightbox.index]}
                  alt={`Construction update photo ${lightbox.index + 1}`}
                  fill
              ...
              <div className="absolute bottom-[-45px] left-1/2 -translate-x-1/2 bg-white/10 backdrop-blur-md text-white px-5 py-2.5 rounded-full text-xs sm:text-sm font-semibold tracking-wider border border-white/15 shadow-xl select-none">
                ...
                <span className="text-white/70">{constructionImages.length}</span>
              </div>
            </div>
          </motion.div>
        )}
